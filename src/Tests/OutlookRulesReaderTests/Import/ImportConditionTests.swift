...
final class ImportConditionTests: XCTestCase {
    func testFromCondition() throws {
        do {
            ...
            XCTAssertEqual(0x8004010F, condition.values[0][PropertyId.tagSmtpAddress.rawValue] as! Int)
            XCTAssertEqual("name", condition.values[0][PropertyId.tagDisplayName.rawValue] as! String)
            XCTAssertEqual(0x8004010F, condition.values[0][PropertyId.tagSmtpAddress.rawValue] as! Int)
            XCTAssertEqual(0x8004010F, condition.values[0][PropertyId.tagSearchKey.rawValue] as! Int)
            XCTAssertEqual(0x8004010F, condition.values[0][PropertyId.tagEntryId.rawValue] as! Int)
            XCTAssertEqual(1, condition.values[0][PropertyId.tagRecipientType.rawValue] as! Int)
        }
        do {
            let file = try OutlookRulesFile(data: Data([
                0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x14, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            ...
            XCTAssertEqual(0x8004010F, condition.values[1][PropertyId.tagSmtpAddress.rawValue] as! Int)
            XCTAssertEqual("name", condition.values[1][PropertyId.tagDisplayName.rawValue] as! String)
            XCTAssertEqual(0x8004010F, condition.values[1][PropertyId.tagSmtpAddress.rawValue] as! Int)
            XCTAssertEqual(0x8004010F, condition.values[1][PropertyId.tagSearchKey.rawValue] as! Int)
            XCTAssertEqual(0x8004010F, condition.values[1][PropertyId.tagEntryId.rawValue] as! Int)
            XCTAssertEqual(1, condition.values[0][PropertyId.tagRecipientType.rawValue] as! Int)
        }
    }
    ...
    func testWithSelectedPropertiesOfDocumentOrFormsCondition() throws {
        ...
        do {
            ...
            XCTAssertEqual(PropertyDataType.string, condition.documentProperties[0].propertyDataType)
        ...
        do {
            ...
            XCTAssertEqual(PropertyDataType.integer32, condition.documentProperties[0].propertyDataType)
            XCTAssertEqual(.contains, condition.documentProperties[0].stringMatchType)
        ...
        do {
            ...
            XCTAssertEqual(PropertyDataType.time, condition.documentProperties[0].propertyDataType)
            XCTAssertEqual(.contains, condition.documentProperties[0].stringMatchType)
            XCTAssertEqual("", condition.documentProperties[0].stringValue)
            XCTAssertEqual(.equals, condition.documentProperties[0].numberMatchType)
            XCTAssertEqual(0, condition.documentProperties[0].numberValue)
        ...
        do {
            ...
            XCTAssertEqual(PropertyDataType.string, condition.documentProperties[1].propertyDataType)
