...
final class ImportConditionTests: XCTestCase {
    ...
    func testWithSelectedPropertiesOfDocumentOrFormsCondition() throws {
        ...
        do {
            ...
            XCTAssertEqual(0x8222, condition.documentProperties[0].id)
            XCTAssertEqual(PropertyType.string, condition.documentProperties[0].dataType)
        ...
        do {
            ...
            XCTAssertEqual(0x8223, condition.documentProperties[0].id)
            XCTAssertEqual(PropertyType.integer32, condition.documentProperties[0].dataType)
            XCTAssertEqual(.contains, condition.documentProperties[0].stringMatchType)
        ...
        do {
            ...
            XCTAssertEqual(0x8228, condition.documentProperties[0].id)
            XCTAssertEqual(PropertyType.time, condition.documentProperties[0].dataType)
            XCTAssertEqual(.contains, condition.documentProperties[0].stringMatchType)
            XCTAssertEqual("", condition.documentProperties[0].stringValue)
            XCTAssertEqual(.equals, condition.documentProperties[0].numberMatchType)
            XCTAssertEqual(0, condition.documentProperties[0].numberValue)
        ...
        do {
            ...
            XCTAssertEqual(0x8222, condition.documentProperties[1].id)
            XCTAssertEqual(PropertyType.string, condition.documentProperties[1].dataType)
