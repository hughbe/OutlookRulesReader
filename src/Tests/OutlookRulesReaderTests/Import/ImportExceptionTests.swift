...
final class ImportExceptionTests: XCTestCase {
    func testFromException() throws {
        do {
            ...
            XCTAssertEqual(0x8004010F, exception.values[0][PropertyId.tagSmtpAddress.rawValue] as! Int)
            XCTAssertEqual("name", exception.values[0][PropertyId.tagDisplayName.rawValue] as! String)
            XCTAssertEqual(0x8004010F, exception.values[0][PropertyId.tagSmtpAddress.rawValue] as! Int)
            XCTAssertEqual(0x8004010F, exception.values[0][PropertyId.tagSearchKey.rawValue] as! Int)
            XCTAssertEqual(0x8004010F, exception.values[0][PropertyId.tagEntryId.rawValue] as! Int)
            XCTAssertEqual(1, exception.values[0][PropertyId.tagRecipientType.rawValue] as! Int)
        }
        do {
            let file = try OutlookRulesFile(data: Data([
                0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x14, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            ...
            XCTAssertEqual(0x8004010F, exception.values[1][PropertyId.tagSmtpAddress.rawValue] as! Int)
            XCTAssertEqual("name", exception.values[1][PropertyId.tagDisplayName.rawValue] as! String)
            XCTAssertEqual(0x8004010F, exception.values[1][PropertyId.tagSmtpAddress.rawValue] as! Int)
            XCTAssertEqual(0x8004010F, exception.values[1][PropertyId.tagSearchKey.rawValue] as! Int)
            XCTAssertEqual(0x8004010F, exception.values[1][PropertyId.tagEntryId.rawValue] as! Int)
            XCTAssertEqual(1, exception.values[0][PropertyId.tagRecipientType.rawValue] as! Int)
        }
    }
    ...
    func testWithSelectedPropertiesOfDocumentOrFormsException() throws {
        ...
        do {
            ...
            XCTAssertEqual(PropertyDataType.string, exception.documentProperties[0].propertyDataType)
        ...
        do {
            ...
            XCTAssertEqual(PropertyDataType.integer32, exception.documentProperties[0].propertyDataType)
            XCTAssertEqual(.contains, exception.documentProperties[0].stringMatchType)
        ...
        do {
            ...
            XCTAssertEqual(PropertyDataType.time, exception.documentProperties[0].propertyDataType)
            XCTAssertEqual(.contains, exception.documentProperties[0].stringMatchType)
            XCTAssertEqual("", exception.documentProperties[0].stringValue)
            XCTAssertEqual(.equals, exception.documentProperties[0].numberMatchType)
            XCTAssertEqual(0, exception.documentProperties[0].numberValue)
        ...
        do {
            ...
            XCTAssertEqual(0x8222, exception.documentProperties[1].propertyId)
            XCTAssertEqual(PropertyDataType.string, exception.documentProperties[1].propertyDataType)
